...
def gen_preds(
    ...
    num: int = None,
    path_to_querys: str = "data/querys.json",
    path_to_tables: str = "data/tables.json",
    path_to_save: str = "report",
):
    samples = load_json(path_to_querys)
...
def evaluate_metrics(
    ...
    num: int = None,
    label_tables_path: str = "data/y_tables.json",
    label_columns_path: str = "data/y_columns.json",
):
...
def main():
    ...
    parser.add_argument(
        "--gen_model_url", required=True, help="http url for llm inference"
    )
    parser.add_argument(
        "--extract_model_url", required=True, help="http url for llm inference"
    )
    parser.add_argument(
        "--path_to_save",
        required=False,
